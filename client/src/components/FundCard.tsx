...
import { CampaignDetails, daysLeft } from '../utils';



const FundCard = ({ owner, title, image, description, target, deadline, amountCollected, handleClick }:CampaignDetails) => {
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="flex items-center mt-[20px] gap-[12px]">
          <div className="w-[30px] h-[30px] rounded-full flex justify-center items-center bg-[#13131a]">
            <img src={tagType} alt="user" className="w-1/2 h-1/2 object-contain"/>
          </div>
